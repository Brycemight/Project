...
-- What is the top 10 games watched in year 2021 in November? 
select  
    Game ,
    `Month` ,
    `Year` ,
    MAX(Hours_watched) AS Most_watched
from 
...
-- What is the top 10 games with the most viewers in year 2021 in November? 
